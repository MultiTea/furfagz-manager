<template>
  ...
  >
    ...
    <div class="flex items-center space-x-4">
      ...
      <div v-if="isSetlist" class="flex-none text-gray-500 font-medium">
        {{ position }}.
      </div>
      ...
      <div class="shrink-0">
        <AudioPreview :preview-url="song.preview_url" :preview-id="'song-' + song.id">
          <img 
      ...
      <div class="flex-1 min-w-0">
        ...
        <div v-if="song.notes" class="mt-1">
          ...
          <p v-if="isNotesVisible" class="mt-1 text-sm text-gray-600">
            {{ song.notes }}
          </p>
        </div>
      </div>
